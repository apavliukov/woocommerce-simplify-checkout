	...
	<div class="row">
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="email" class="input-text form-control" name="billing_email" id="billing_email" value="<?php esc_attr_e( get_address_field_value($customer_id, 'billing_email') ); ?>" />
				</div>
			</div>
